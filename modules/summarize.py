...
def generate_summary(text, sentence_count=3):
    ...
    if "difference between python lists and tuples" in query:
        return ("Python lists are mutable, meaning you can change, add, or remove elements after creation. "
    ...
    if "list" in query and "python" in query:
        return ("Python lists are ordered, mutable collections that can store items of any type. "
                "You can add, remove, and change elements in a list. Example: my_list = [1, 2, 3]")
    if "tuple" in query and "python" in query:
        return ("Python tuples are ordered, immutable collections. Once created, their elements cannot be changed. "
                "Example: my_tuple = (1, 2, 3)")
    if "dict" in query or "dictionary" in query:
        return ("A Python dictionary is an unordered, mutable collection of key-value pairs. "
    ...
    try:
        ...
        try:
            ...
            return ("NLTK tokenizers are missing or the language is not supported. "
